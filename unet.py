...
from dataset import Training_Generator, Testing_Generator, load_train_data, load_test_idxs, split_dataset, reweight_sample, load_binary_train, reweight_binary_sample
...
def arg_parser():
    ...
    parser.add_argument("--model", type=str, default = 'unet.h5')
    parser.add_argument("--output", type=str, default = 'unet_output.csv')
...
class UNet():
    ...
    def __init__(self, MODEL, preprocess_func = None, use_attn = True, input_dim = (150, 150, 3),
     ...
     fine_tune = True, kernel_l2 = 0.01, reweight = False, model_weight = 'imagenet'):
        ...
        # print(base_pretrained_model.get_output_shape_at(0))
        # input()
        ...
        out_layer = Dense(14, activation = 'sigmoid')(dr_steps)
