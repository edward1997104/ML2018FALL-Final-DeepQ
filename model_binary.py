...
class XRAY_model():
    ...
    def __init__(self, idx, model_type_list, preprocess_func_list = None, use_attn = True, input_dim = (150, 150, 3),
    ...
    def fit(self, idx, validation_ratio = 0.1):
    ...
    def save_weight(self, path = './baseline'):
        print ("Start Saving model")
        os.makedirs(path, exist_ok=True)
        self.model.save(path + '/' + str(self.idx) + '.h5')
        print ("Done Saving model")
        return

    def load_weight(self, path = './baseline'):
        print ("Start Loading model")
        self.model.load_weights(path + '/' + str(self.idx) + '.h5')
...
if __name__ == "__main__":
    ...
    result = np.zeros((len(test_idxs), 14))
    for i in range(14):
        model = XRAY_model(i, model_type_list, output_dim = 1
        ...
        if args.training:
            model.fit(idx = i, validation_ratio = args.validation_ratio)
    ...
    output_csv(result, output_idx, output_path = args.output)